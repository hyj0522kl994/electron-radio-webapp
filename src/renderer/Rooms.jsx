...
import Live from './components/playcomponents/live';
import Streaming from './components/playcomponents/streaming';
    ...
    render() {
      ...
      return (
        <div className="pane-group">
          <div className="pane-sm sidebar"><Navi />
          {this.renderRoomList()}</div>
          <div className="pane"><Live /></div>
